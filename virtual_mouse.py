...
def countFingers(image, hand_landmarks, handNo=0):
	...
	if hand_landmarks:
		...
		print(distance)
		print("computer_screen_size",screen_width,screen_height,"output_window_size",width,height)
		print("mouse_position",mouse.position,"tips_line_center_position",center_x,center_y)
